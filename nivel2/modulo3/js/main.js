...
require.config({
	...
	// Also, the path should NOT include the '.js' file extension. This example is using jQuery 1.9.0
	// located at js/lib/jquery-1.9.0.js, relative to the HTML page.
	jquery : 'jquery/jquery',
	backbone : 'backbone/backbone',
	underscore : 'backbone/underscore',
	backboneLocalStorage : 'backbone/backbone.localStorage',
	jqueryJeditable : 'jquery/jquery.jeditable',
	jqueruUI : 'jquery/jquery-ui'
    } 
});

require(['jquery', 'jqueruUI', 'backbone', 'backboneLocalStorage', 'underscore', 'jqueryJeditable'], function($) {
